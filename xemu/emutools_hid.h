...
extern void hid_joystick_motion_event   ( int which, int is_vertical, int value ) ;
extern void hid_joystick_button_event   ( int which, int pressed ) ;
extern void hid_joystick_hat_event      ( int which, int value ) ;
extern int  hid_read_joystick_up        ( int which, int on, int off ) ;
extern int  hid_read_joystick_down      ( int which, int on, int off ) ;
extern int  hid_read_joystick_left      ( int which, int on, int off ) ;
extern int  hid_read_joystick_right     ( int which, int on, int off ) ;
extern int  hid_read_joystick_button    ( int which, int on, int off ) ;
